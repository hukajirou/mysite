...
urlpatterns = [
    ...
    path("store/<int:store_id>/<int:service_id>/",views.StoreDetailView.as_view(),name="store_detail",),
    # 店舗登録
    path("store_register/", views.StoreRegisterView.as_view(), name="store_register"),
    # サービス登録
    path("service_register/",views.ServiceRegisterView.as_view(),name="service_register",),
    # 店舗特別休日
